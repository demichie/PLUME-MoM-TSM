  ...
  SUBROUTINE plumerise
    ...
    DO i_part=1,n_part
       ...
       IF ( dakota_flag ) THEN
          ...
          description = 'Volume flow rate NBL  '

          CALL write_dakota(description,pi_g * radius_nbl**2 * w_nbl)

          description = 'U atm NBL '

          CALL write_dakota(description,u_wind_nbl)

          description = 'V atm NBL'

          CALL write_dakota(description,v_wind_nbl)
