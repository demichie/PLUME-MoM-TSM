...
plumemom_dir = "/home/Codes/PLUME-MoM-TSM-master"    #please do not modify the paths of PLUME-MoM and Hysplit
runname = 'Etna_test'
...
log10_mfr = 5 
#mfr = 1E5
#plume_height = 5000 #plume height above the vent inversion: search for radius given vent_velocity
...
# particle distribution can be LOGNORMAL, BIN or SOLID
...
rcoef_flag = "F" # True or false

# parameters for BIN distribution
bin_partial_mass_fraction = [4.3E-02 ,1.1E-01 ,2.1E-01, 2.5E-01, 2.1E-01 ,1.1E-01, 4.3E-02, 1.1E-02, 1.9E-03, 2.2E-04, 1.7E-05, 9.3E-07, 3.4E-08, 8.2E-10, 1.4E-11, 1.5E-13]
