...
runname = 'VOLCITA_2019'
starttime="19 11 19 06 30" # Year,month,day,hour,minute
endemittime = "19 11 19 16 30"
endruntime = "19 11 19 16 30"
deltat_plumemom = 3600  # seconds

lat = 40.82   # center latitude of the grid
lon = 14.43  # center longitude of the grid
model_top = 32000.0
meteo_file = 'extract_13616.bin'
...
vent_lat = 40.82   	# vent latitude
vent_lon = 14.43     # vent longitude
vent_height = 1281   # vent height above sea level (it can be different from ground level of meteo data at vent lat,lon)
vent_velocity = 200.0
plume_height = 12719 # options: log10_mfr or plume_height (plume height above the vent)
...
#Flight Levels (FL) for forecast simulations. FLOOO (0m),FL200 (6100m),FL350 (10650m),FL5500 (16764m)
H_LEVELS = '0 6100 10650 16764'  
